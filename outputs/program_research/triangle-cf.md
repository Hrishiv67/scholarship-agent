...
**URL:** https://www.trianglecf.org/grants-scholarships/scholarships/
**Application Opens:** Not found on page -- typically January
**Deadline:** Not found -- check https://www.trianglecf.org/grants-scholarships/scholarships/
**Award:** $500-$5,000 varies by scholarship
**Tier:** Accessible
...
## Notes
Research failed: API call failed: Error code: 404 - {'type': 'error', 'error': {'type': 'not_found_error', 'message': 'model: claude-sonnet-4-5-20251015'}, 'request_id': 'req_011CeNi5UV6ZE9wQNBywYFsq'}. Check https://www.trianglecf.org/grants-scholarships/scholarships/ manually.
