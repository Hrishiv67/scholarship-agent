# Naval Research Lab (NRL) Summer Internship

**URL:** https://www.nrl.navy.mil/careers/internship/
**Application Opens:** Not found on page -- typically October
**Deadline:** Not found -- check https://www.nrl.navy.mil/careers/internship/
...
## Notes
Research failed: API call failed: Error code: 404 - {'type': 'error', 'error': {'type': 'not_found_error', 'message': 'model: claude-sonnet-4-5-20251015'}, 'request_id': 'req_011CeNi7UPTAy3itDDFnGPiH'}. Check https://www.nrl.navy.mil/careers/internship/ manually.
