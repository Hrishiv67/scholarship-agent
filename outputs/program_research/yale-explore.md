# Yale EXPLORE (Diversity Fly-In)

**URL:** https://admissions.yale.edu/diversity-programs
**Application Opens:** Not found on page -- typically October
**Deadline:** Not found -- check https://admissions.yale.edu/diversity-programs
...
## Notes
Research failed: API call failed: Error code: 404 - {'type': 'error', 'error': {'type': 'not_found_error', 'message': 'model: claude-sonnet-4-5-20251015'}, 'request_id': 'req_011CeNiAUEMgPfZGpY6YjGM5'}. Check https://admissions.yale.edu/diversity-programs manually.
