...
**URL:** https://admissions.wustl.edu/discover/diversity/
**Application Opens:** Not found on page -- typically October
**Deadline:** Not found -- check https://admissions.wustl.edu/discover/diversity/
**Award:** all-expenses campus visit to Washington University in St. Louis
**Tier:** Competitive
...
## Notes
Research failed: API call failed: Error code: 404 - {'type': 'error', 'error': {'type': 'not_found_error', 'message': 'model: claude-sonnet-4-5-20251015'}, 'request_id': 'req_011CeNiBwC7gyt4UGwzZqiy5'}. Check https://admissions.wustl.edu/discover/diversity/ manually.
